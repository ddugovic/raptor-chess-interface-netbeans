...
public class MoveListVariation {
	private final List<Integer> moveNodes = new ArrayList<Integer>();
	private final List<Integer> moveNodesLengths = new ArrayList<Integer>();
	private final List<String> moveSans = new ArrayList<String>();
	private final int startingMove;
	private final int startOffset;
	private final Game varGame;
